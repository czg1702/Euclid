...
"  (  [starting region].[Asia].[China],  Transport.railway, [measure].[quantity] ), " \
"  ( [starting region].[Asia].[China], Transport.highway, [measure].[quantity] ), " \
"  ( Goods.[foods].[nut], Transport.[railway], [starting region].[Asia].[China] )  " \
"} on 0, " \
"{ " \
"  ( [starting date].[2019].[Q4].[M10], Goods.[foods].[nut], [measure].[income] ), " \
